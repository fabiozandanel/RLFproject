...
\begin{equation}
F_{\gamma} (>E_{\gamma}) = \frac{1}{D^{2}} \int dV  j_{\gamma}(R)\, ,
\end{equation}

where the gamma-ray emissivity above $E_{\gamma}$ and per steradian is $ j_{\gamma}(R)=A_{\gamma} C(R) \rho_{\rmn{gas}}(R)$. The parameter $A_{\gamma}$ is \citep{2010MNRAS.409..449P}
