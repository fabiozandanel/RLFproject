...
\caption{Left panel: we show our final hybrid model profile for the normalization of
  ...
  $R_{200}$. Right panel: we compare the final hybrid model with the semi-analytical
...
$\alpha = 2.3$ in this last case.\footnote[9]{We checked that
  the choice of $\alpha$ in Equation~(\ref{eq:Csimple_1}), and therefore in Equation~(\ref{eq:Ctransport}), has only a minor
...
normalization for the NCCC and CCC cases and for different values of $\gamma_{\rmn{tu}}$. As
