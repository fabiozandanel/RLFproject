...
\begin{keywords}
  Galaxies: clusters - Radio continuum - Gamma rays - X-rays: galaxies: clusters
\end{keywords}
...
RH asphericity in Section 3.5), which would eventually have to
...
Interestingly, the detected signal of Mpc-scale diffuse emission in a
stacked sample of radio-quiet galaxy clusters (shown in green in the
