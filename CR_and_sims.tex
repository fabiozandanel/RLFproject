...
transport and the different scalings of $L_{\rmn{X}}$ and $Y$ with gas density,
our model is also able to simultaneously reproduce the observed bimodality of
radio-loud and radio-quite clusters at the same X-ray luminosity $L_{\rmn{X}}$
as well as the unimodal distribution of radio-halo luminosity versus
Sunyaev-Zel'dovich flux, $Y$; thereby suggesting a physical solution to this
...
\item The radio mini-halos in Perseus and Ophiuchus can be easily reproduced in
  ...
  (i) Primary electrons accelerated in outer shocks, which we do not consider here,
