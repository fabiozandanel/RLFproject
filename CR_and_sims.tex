...
\titlerunning{On the Physics of Radio Halos in Galaxy Clusters: Scaling Relations and Luminosity Functions}
...
come from detailed RH population analyses. To date, \C{we know only of 53 clusters
...
%The total is obtained integrating up to $z_{2} = 2$ as above this value only few
%clusters survive our mass cut and none would be detectable.
