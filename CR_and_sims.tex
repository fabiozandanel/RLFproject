...
\caption{Surface brightness modeling of the RHs in Coma, Abell~2163, Perseus and
  ...
  because of the overestimation of the data point errors. For Coma and Abell~2163, in the left panel, 
  we additionally show the radial missing power of the model with respect to the observational data.} 
