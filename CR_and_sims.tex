...
considered, i.e., for $2.1\lesssim \alpha\lesssim2.5$. \cite{2004A&A...413...17P}
demonstrates that those spectral indices provide a fair description of
...
%\citep[see Fig.~8
%in][which demonstrates that those spectral indices provide a fair description of
%the radio emission after taking into account the negative flux bowl due to the
%Sunyaev-Zel'dovich effect that causes the measured radio halo spectrum to
%experience a sharp cutoff towards high frequencies]{2004A&A...413...17P}. 

This is not necessarily in conflict with results by \citet{2012arXiv1207.3025B} who
point out problems of the hadronic model for the {\em limited} parameter space
$\alpha\gtrsim2.6$, while adopting a slightly shallower azimuthally averaged
radio halo profile \citep{2011MNRAS.412....2B} than the one used in this
analysis \citep{1997A&A...321...55D}. Careful work is needed to understand the
origin of the observational discrepancy and to cleanly separate the radio halo
emission from that of the Coma radio relic and other sources in the field.

\C{Additionally, \citet{2012arXiv1207.3025B} need very flat CR profiles both for 
their hadronic and re-acceleration models in order to be alto to reproduce 
the Coma surface brightness. Interestingly, this is similar to what we found here 
both for the Coma and Abell~2163 cases.}
...
\C{We exclude RXCJ1314.4-2515 and Z7160 because they lack bolometric X-ray measurements.} 
