...
\institute {Instituto de Astrof\'{\i}sica de Andaluc\'{\i}a (CSIC), Glorieta de la Astronom\'{\i}a, E-18080 Granada, Spain, fabio@iaa.es
 \and Heidelberg Institute for Theoretical Studies, Schloss-Wolfsbrunnenweg 35, D-69118 Heidelberg, Germany, christoph.pfrommer@h-its.org
...
and NCCC) gas profiles \citep[of the REXCESS sample][]{2008A&A...487..431C}, a
cluster-mass-dependent gas fraction \citep{2009ApJ...693.1142S}, and the
universal temperature drop in the outskirts of clusters seen in simulations and
deep X-ray observations. We assign such a (cluster mass-dependent) gas density
...
VERITAS, and H.E.S.S. Future and more sensitive gamma-ray observations may in
...
number depends strongly on the underling assumptions and. In particular, we
...
low-sensitivity radio instruments, in determining the RLF properties. In
combination with future X-ray missions like eROSITA, this should yield a robust
determination of the number of clusters hosting RHs at a given luminosity (mass)
and thus elucidate the relation of the radio emission with cluster dynamical
...
will make these catalogs publicly and freely available on-line. Those contain
the quantities $\rho_{\rmn{gas}}$, $L_{\rmn{X, bol}}$, $Y_{\rmn{X}}$,
