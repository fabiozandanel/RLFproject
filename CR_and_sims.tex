...
\begin{figure*}[t]
\centering
\includegraphics[width=0.62\textwidth]{figures/CR_profiles_FinalModel_paper.eps}
...
$\alpha = 2.3$ in Equation~(\ref{eq:Ctransport}),\footnote{We checked that
...
%% this part was moved from the main text:
%% STARTING HERE
