...
luminosity, $L_\rmn{X}$, exhibits a larger scatter. {\bf The CCCs predominantly
...
\cite{2010MNRAS.409..449P} ({\bf we fall short of the luminosities predicted by
\citealp{2010MNRAS.409..449P} and \citealp{2011arXiv1105.3240P} because 
we additionally account for the central temperature dip and outer decrease}).
...
\item The small cluster sample analysed here was only meant to serve as a proof
  ...
  our hybrid hadronic model. {\bf This is in particular true} because of the
  ...
  function. {\bf This is particularly true} for the analyzed radio mini-halos, for
